...
namespace InventoryStudio.Controllers.OrderManagement
{
    public class SalesOrderLineController : BaseController
    {
        ...
        public SalesOrderLineController(IHttpContextAccessor httpContextAccessor)
        {
        ...
        private SalesOrderLineViewModel EntityConvertViewModel(SalesOrderLine salesOrderLine)
        {
            ...
            var auditDataList = AuditData.GetAuditDatas("SalesOrderLine", viewModel.SalesOrderLineID);
